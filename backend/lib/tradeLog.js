...
const PHASE_LOG_TYPES = new Set(['PHASE0_TRACE', 'PHASE1_SHADOW', 'RSI_GATE_PASS', 'SCORE_BAND_PASS', 'ARM_CANCEL', 'PCT_BAND_SHADOW']); // hotfix40: fixPCTBANDSHADOW evidence-gathering line

...
function computeVolumeDelta() {
  if (!_priceMapSnapshot) return { score: 0, label: 'No Data', bull_pct: 0, bear_pct: 0, neutral_pct: 0, pair_count: 0 }; // fix39/M-12: was returning fake 50/50 — now returns 0/0 to signal no data

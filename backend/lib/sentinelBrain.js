...
function computeGates(market_regime, wrData, fundDanger) {
  ...
  const bearBuyGate = buyAgainstTrend ? 85 : BASE_SCORE_GATE;  // was BASE+5 — not enough
...
async function runSentinel() {
  ...
  try {
    ...
    const gates = computeGates(confirmedRegime, wrData, fund.danger);

...
function computeAllowedSides(market_regime, wrData, fundDanger) {
  ...
  if (bullRegimes.includes(market_regime)) {
    ...
    // CHOP: fix33-obs6: block both sides. Higher gates alone were not enough —
    // signals still fired in CHOP causing losses. Block all new entries in chop.
    // sides stays empty = blocked.
  }

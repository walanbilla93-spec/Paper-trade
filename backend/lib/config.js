...
const DEFAULTS = Object.freeze({
  ...
  maxOpenTrades: parseInt(process.env.MAX_OPEN_TRADES || process.env.AUTO_TRADE_MAX_OPEN || '50', 10) || 50, // fix37: default 10->50 per UI settings
  ...
  minScoreToTrade: parseNumber(process.env.MIN_SCORE_TO_TRADE, 72), // fix31: raised 70→72. Score 70-71 had 0 wins in current data; 72+ has positive expectancy.
  ...
  v4EntryWaitSeconds: parseNumber(process.env.V4_ENTRY_CONFIRMATION_WINDOW_SECONDS, 90), // fix33-obs2: was 10 — scan interval=20s, window must be > scan interval

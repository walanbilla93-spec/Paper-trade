...
const DEFAULTS = Object.freeze({
  ...
  v4MinRR: parseNumber(process.env.V4_MIN_RR, 1.9),
  ...
  v4WaitingExpiryMinutes: parseNumber(process.env.V4_SIGNAL_EXPIRY_MINUTES || process.env.SIGNAL_EXPIRY_MINUTES, 45),
  ...
  v4MinNetTpUsdt: parseNumber(process.env.V4_MIN_NET_TP_USDT, 0.05),
  ...
  version: '4.6.8-ledger-ui-stabilizer'
});

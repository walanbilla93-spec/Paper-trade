...
const DEFAULTS = Object.freeze({
  ...
  // fix27: data shows SELL WR=18% (2W/11L) — raise SELL gate to 68 to filter low-confidence SELLs.
  // BUY WR=55% at gate=45 — BUY gate stays at 45.
  v4MinSellScore: parseNumber(process.env.V4_MIN_SELL_SCORE, 68),

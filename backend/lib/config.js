...
const DEFAULTS = Object.freeze({
  ...
  v4MinBuyScore: parseNumber(process.env.V4_MIN_BUY_SCORE, 48),   // FIX1: was 60; no-structure hard cap is 50, so 60 blocked all signals without full S/R
  v4MinSellScore: parseNumber(process.env.V4_MIN_SELL_SCORE, 72), // FIX1: was 86; lowered to match realistic SELL score ceiling with filters active
  ...
  v4AllowSells: parseBool(process.env.V4_ALLOW_SELLS, true),  // FIX2: was false; SELLs were permanently disabled
  ...
  rejectMixedBtcRegime: parseBool(process.env.V4_REJECT_MIXED_BTC_REGIME || process.env.REJECT_MIXED_BTC_REGIME, false), // FIX3: was true; sideways BTC blocked everything
  ...
  v4MinBuyEntryTimingScore: parseNumber(process.env.V4_MIN_BUY_ENTRY_TIMING_SCORE, 65),  // FIX4: was 85; score at 0.5-1.0 ATR is 68-82, 85 blocked everything
  v4MinSellEntryTimingScore: parseNumber(process.env.V4_MIN_SELL_ENTRY_TIMING_SCORE, 70), // FIX4: was 92; unreachable without perfect entry

...
const DEFAULTS = Object.freeze({
  ...
  minScoreToTrade: parseNumber(process.env.MIN_SCORE_TO_TRADE, 45),

  // fix25: side-specific scores align with new 0-100 scale.
  v4MinBuyScore: parseNumber(process.env.V4_MIN_BUY_SCORE, 45),

  // SELLs slightly higher bar due to BTC bull regime being common.
  v4MinSellScore: parseNumber(process.env.V4_MIN_SELL_SCORE, 45),

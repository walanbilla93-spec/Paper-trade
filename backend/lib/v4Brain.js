...
const V4_VERSION = '4.6.8.48q'; // fix48q: (1) ORPHAN-STATE PURGE — startup force-EXPIREs any signal whose paperState is in neither ACTIVE nor FINAL set (the recurring OPN/BCH zombie, source:NaN). (2) cancelSignal can now invalidate an orphan too (button did nothing before). (3) SCORE-FLOOR enforced on retry path (fresh-build + stale fallback) — OPN fired at 68 after floor set to 70. Carries all 48p/48o/48n2 fixes.

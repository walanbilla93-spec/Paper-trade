...
const V4_VERSION = '4.6.8.48k'; // fix48k: WAITING hard-cap keyed to immutable signalId birth epoch (kills zombie WAITING signals that ate open slots); ENTRY_TIMING>=44 activation block (net-negative band, N=193 robust); display fixes (sentinel row, session-reset, source label). No brain/score/RR/sentinel logic changes.

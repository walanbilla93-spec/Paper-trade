...
const V4_VERSION = '4.6.8.48r'; // fix48r: (1) DATA-CAPTURE fix — getSentinelForCapture() caches last-good sentinel + falls back instead of writing null (was ~60% of closed trades untagged); adds sentinelStaleAtEntry/sentinelAgeMsAtEntry honesty flags. (2) rsiAtEntry tries all sources (was 100% null). (3) score-clamp ceiling 68→75 (was eating the 70 floor). Carries all 48n2-48q fixes.

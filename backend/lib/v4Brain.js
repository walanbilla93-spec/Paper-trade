...
const V4_VERSION = '4.6.8.48m-instr'; // fix48m-instr: INSTRUMENTATION ONLY (no gates/logic changes). Capture market-sentinel context at entry: breadthBullPctAtEntry, fundingRateAtEntry, sentinelCompositeAtEntry, sentinelAllowedAtEntry. Harden rsiAtEntry/atrPctAtEntry fallbacks (were ~70% null). Zombie expiry fix retained from 48l.

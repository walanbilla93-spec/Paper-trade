...
const V4_VERSION = '4.6.8.49c'; // fix49c: GTC waiting limit at signal.entry + liveOrderId guard + EXPIRED cancel + reconciler 50min timeout. fix49b: reject hardDrift >1%, SL/TP from signal levels not pct-of-bybitPrice.

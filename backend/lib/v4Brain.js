...
const V4_VERSION = '4.6.8.48u'; // fix48u: VERSION-REPORTING UNIFICATION. /health and /api/v4/status now report V4_VERSION (the live code constant) instead of stale hardcodes (config DEFAULTS.version=47, v4 status=30). Frontend label/CSV-name constant aligned. /health is now the single deploy-truth. NO trading-behaviour change. Carries 48s breadth-override + 48t shadow-capture + all 48n2-48r fixes.

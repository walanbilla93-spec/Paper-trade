...
const V4_VERSION = '4.6.8.48o'; // fix48o: funding override DOWNGRADES instead of vetoing the WITH-TREND side. In confirmed trend, overshort no longer removes SELL (bear) / overlong no longer removes BUY (bull) — squeeze risk handled via +4 score-gate bump in computeGates + trade mgmt. Counter-trend side + CHOP keep old veto. Fixes SNDK case (STRONG_BEAR stripped SELL). Plus 48n2: REGIME_CONFLICT guard, sentinel CSV cols.

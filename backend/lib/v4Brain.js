...
const V4_VERSION = '4.6.8.48y'; // fix48y: FEES/SLIPPAGE removed from paper P&L (FEE_RATE=0, SLIPPAGE_RATE=0). cost=0 → netTp=grossTp, netSl=-grossSl → realized RR = planned RR (was crushed to ~1.2x by oversized 0.20% round-trip model). Real fees (~0.013-0.02/trade) to be extracted from Bybit. Reversible via env. Carries all prior fixes.

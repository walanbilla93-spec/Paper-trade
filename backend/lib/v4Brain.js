...
function _ledgerRowSig(r) {
  ...
  return `${r.id || r.key || ''}|${r.paperState || r.result || ''}|${num(r.realizedPnl, 0)}|${num(r.closedAt, 0)}|${mfe}|${mae}`;
}

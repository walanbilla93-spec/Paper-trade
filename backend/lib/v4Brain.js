...
function shouldReject(leader, settings, signals = []) {
  ...
  const minRR = minRRFor(leader.side, settings, leader.score); // fix28: tiered — score>=75 gets 1.5, score<75 gets 1.8

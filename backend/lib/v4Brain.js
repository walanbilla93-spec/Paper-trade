...
const directionMode = require('./directionMode'); // fixWIRE: switchable direction engine + extension gate // fix44f: squeeze/trap/BOS/CHoCH/divergence + fix46c: Elliott Waves

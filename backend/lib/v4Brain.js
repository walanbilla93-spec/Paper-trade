...
const V4_VERSION = '4.6.8.48i'; // fix48i: sentinel reconnected SAFELY — narrow binary side-block (anti-throttle, stale-guarded) + active-position regime-flip exit. No gate inflation.

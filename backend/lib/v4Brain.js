...
const V4_VERSION = '4.6.8.48l-revert'; // fix48l-revert: zombie expiry fix KEPT (all 3 paths use signalBirthMs); backend-alerts feature REMOVED to isolate deploy crash; ALL THREE waiting-expiry paths (2618/2644/3612) now keyed to immutable signalBirthMs (48k only fixed one; CRV zombie slipped through the other two). Backend-persisted alerts added. No brain/score/RR/sentinel/direction logic changes.

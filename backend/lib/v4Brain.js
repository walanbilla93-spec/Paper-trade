...
const V4_VERSION = '4.6.8.41'; // fix41: time gate (06,07,23,00 UTC dead hours blocked); fix-A: frontend btcRegime from server
...
// fix-timegate: low-liquidity hours — Asia close (06-07 UTC) and NY close/dead zone (23-00 UTC).
// Data: 17% WR at 06:00, 0% WR at 07:00, 17% WR at 23:00, 33% WR at 00:00 across 118 trades.
// Existing open signals are still managed (SL/TP tracking continues). Only NEW signal generation blocked.
const BAD_SCAN_HOURS_UTC = new Set([6, 7, 23, 0]);
function isDeadHour() {

...
const EXPIRY_MS = Math.max(5, Number(process.env.V4_SIGNAL_EXPIRY_MINUTES || process.env.SIGNAL_EXPIRY_MINUTES || 30)) * 60 * 1000; // fix30: align with config.js DEFAULTS.v4WaitingExpiryMinutes=30

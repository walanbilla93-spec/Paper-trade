...
const V4_VERSION = '4.6.8.49a'; // fix49a: contextWeighting default→OFF (was ghost-towning all markets with bearish breadth; 13-22% score penalty pushed every signal below minScoreToTrade=70). Penalty curve needs recalibration — re-enable via CONTEXT_WEIGHTING=true. Carries 48z SELL-unblock + zombie sweep.

...
const MIN_SELL_RR = Math.max(MIN_RR, Number(process.env.V4_MIN_SELL_RR || '2.1'));
...
const V4_VERSION = '4.6.0-ew-strategy-hardened';
...
function shouldReject(leader, settings, signals = []) {
  ...
  if ((settings.entryConfirmationRequired || ENTRY_CONFIRMATION_REQUIRED) && !entryConfirmationOk(leader)) reasons.push('ENTRY_CONFIRMATION_MISSING');

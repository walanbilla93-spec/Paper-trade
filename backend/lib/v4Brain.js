...
const V4_VERSION = '4.6.8.48s'; // fix48s: BREADTH-OVERRIDE experiment — in BTC-labelled bear, when live breadth is green (bull_pct>=65, toggle breadthOverrideBuy default ON) relax bear BUY gate 85→70 (BUY-only, SELL/composite untouched). Tags breadthOverrideAtEntry for the green-breadth control group. Reversible via BREADTH_OVERRIDE_BUY=false. Carries all 48n2-48r fixes.

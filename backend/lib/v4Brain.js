...
const V4_VERSION = '4.6.8.48t'; // fix48t: SHADOW-CAPTURE for the breadth-vs-flip arbitration. When CONTRARIAN_FLIP turns a BUY→SELL, freeze the original BUY plan (entry/sl/tp1/rr/score) onto the signal as preFlip and tag contrarianFlipAtEntry — the real SELL fires (flip edge untouched), the phantom BUY is recorded for offline kline replay. Adds 7 CSV cols. NO trading-behaviour change. Carries 48s breadth-override + all 48n2-48r fixes.

...
router.get('/settings', auth, (req, res) => {
  res.json({
    ...
    editable: [
      ...
      'minSlDistancePct','v4MinRR','v4MinSellRR','minEntryTimingScore','v4EntryReactionBps','v4EntryWaitSeconds','v4EntryToleranceAtr','v4WaitingExpiryMinutes','v4SymbolLossCooldownMinutes','btcRegimeMode','elliottWaveWeight','experimentPresetMode','minTurnover24h','maxSignalAgeMinutes'
    ],
    secretKeys: {
      bybitApiKey: keySet(),
